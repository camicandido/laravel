...
<body>
    <div class="container">
        <a class="btn btn-primary"  href="{{route('tipoproduto.create')}}">Cadastrar um novo tipo de produto</a>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    <a class="btn btn-outline-primary" href="{{route('tipoproduto.show', $resource['id'])}}">Mostrar</a>
                    <a class="btn btn-outline-secondary" href="{{route('tipoproduto.edit', $resource['id'])}}">Editar</a>
                    <a class="btn btn-outline-danger delButton" data-toggle="modal" data-target="#modalDelete" value="{{route('tipoproduto.destroy', $resource['id'])}}">Remover</a>
                <td>
                    <tr>
            @endforeach
            </tbody>
